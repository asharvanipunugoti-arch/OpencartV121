...
public class DataProviders {
	...
	public String[][] getData() throws IOException
	{
		...
		String logindata[][]= new String[totalrows][totalcols]; //created for 2D array which can store excel data
		
		for(int i=1;i<=totalrows;i++)  //1 //read the data from xl storing in the 2D array
		{
